    ...
    <>
      {color === "transparent" && (
        <S.Header color={color}>
          <GiHamburgerMenu size={30} style={{cursor: "pointer"}} onClick={() => setOpenToggleMenu(!openToggleMenu)} />
          <S.NavLink to="/cart">
      ...
      {color !== "transparent" && (
        <S.Header color={color}>
          <GiHamburgerMenu size={30} color="white" style={{cursor: "pointer"}} onClick={() => setOpenToggleMenu(!openToggleMenu)} />
          <S.NavLink to="/cart">
            <S.Items>{cart.length}</S.Items>
            {user?.type === "seller" ? (
      ...
      <S.BackgroundModal openToggleMenu={openToggleMenu} >
        <S.ToggleMenu openToggleMenu={openToggleMenu} >
          ...
          <div className="third-child" >
            ...
            <S.ToggleMenuLink onClick={ () => logout(history) } >Sair</S.ToggleMenuLink>
          </div>
        </S.ToggleMenu>
      </S.BackgroundModal>
    </>
